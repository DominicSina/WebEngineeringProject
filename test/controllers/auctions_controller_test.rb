...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { active: @auction.active, description: @auction.description, end_time: @auction.end_time, name: @auction.name } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { active: @auction.active, description: @auction.description, end_time: @auction.end_time, name: @auction.name } }
